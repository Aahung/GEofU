...
if ((!$lang)||(!quiz)||(!finalExam)) {
    $fillGeBase = '
                    <div class="list-group">
                        <a class="list-group-item">我要第一个提供数据</a>
                    </div>';
}
?>
    ...
    <div class="container">
        <div class="row">
            <div class="page-header">
                <h1><?php echo $geCode ?><small><?php echo $name ?></small><small><?php if (!$name_CN) { echo "<a>点击此处提供中文翻译</a>";} else echo $name_CN ?></small></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
        ...
        ?>
            ...
            <div class="col-lg-4" id="commentForm">
                ...
                <div class="panel col-lg-12">
                    ...
                    <?php include_once("part_form_comment.php") ?>
                </div>
                <div class="panel col-lg-12">
